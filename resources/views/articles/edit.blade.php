                ...
                <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                    <form action="{{ route('articles.update',$article) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" value="{{ $article->author }}" name="author" id="author" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadowoutline">
                        </div>
